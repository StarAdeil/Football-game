...
class Club extends Team{
	constructor(name,country,win,loose,draw,train){
		super(name,country,win,loose,draw);//Создаем екземпляр родительского обьекта , и получаем доступ к свойствам
		this["Количество тренировок"] = train;
	}
...
let team3 = new Club("Лисы","Украина",0,0,0,0);
console.log(team3["Имя Команды"]);